...
async function activate(context) {
    ...
    context.subscriptions.push(coc_nvim_1.services.registLanguageClient(client), coc_nvim_1.commands.registerCommand("docker.version", async () => {
        const v = JSON.parse(fs_1.default.readFileSync(path_1.default.resolve(__dirname, '..', 'package.json'), 'utf-8')).version;
        coc_nvim_1.window.showInformationMessage(`Version: ${v}`);
    }));
}
